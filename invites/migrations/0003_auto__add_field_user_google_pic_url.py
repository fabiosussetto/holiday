...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'User.google_pic_url'
        db.add_column('invites_user', 'google_pic_url',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'User.google_pic_url'
        db.delete_column('invites_user', 'google_pic_url')
