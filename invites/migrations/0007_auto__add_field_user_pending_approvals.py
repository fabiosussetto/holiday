...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'User.pending_approvals'
        db.add_column('invites_user', 'pending_approvals',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'User.pending_approvals'
        db.delete_column('invites_user', 'pending_approvals')
