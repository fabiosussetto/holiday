...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'User.paymill_client_id'
        db.add_column('invites_user', 'paymill_client_id',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'User.paymill_client_id'
        db.delete_column('invites_user', 'paymill_client_id')
