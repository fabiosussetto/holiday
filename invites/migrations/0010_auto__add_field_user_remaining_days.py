...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'User.remaining_days'
        db.add_column('invites_user', 'remaining_days',
                      self.gf('django.db.models.fields.SmallIntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'User.remaining_days'
        db.delete_column('invites_user', 'remaining_days')
    ...
    models = {
        ...
        'invites.user': {
            ...
            'project': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['holiday_manager.Project']"}),
            'remaining_days': ('django.db.models.fields.SmallIntegerField', [], {'null': 'True', 'blank': 'True'})
        }
    }
