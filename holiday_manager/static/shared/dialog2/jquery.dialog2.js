...
(function($) {
    ...
    Dialog2.prototype = {
	    ...
	    dialogLoad.call(handle, url, this.__ajaxCompleteTrigger, this.__ajaxBeforeSend, this._settings);
	...
	function dialogLoad(url, completeCallback, beforeSendCallback, settings) {
		...
		if ( off >= 0 ) {
			...
			url = url.slice( 0, off );
                ...
                var ajax_settings = $.extend(default_settings, settings.ajax);
		
		// Request the remote document
		jQuery.ajax(ajax_settings).done(function( responseText ) {
