...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ApprovalGroup.is_default'
        db.add_column('holiday_manager_approvalgroup', 'is_default',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ApprovalGroup.is_default'
        db.delete_column('holiday_manager_approvalgroup', 'is_default')
