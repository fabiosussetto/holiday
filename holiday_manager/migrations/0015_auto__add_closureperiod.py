...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ClosurePeriod'
        db.create_table('holiday_manager_closureperiod', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['holiday_manager.Project'])),
            ('start', self.gf('django.db.models.fields.DateField')()),
            ('end', self.gf('django.db.models.fields.DateField')()),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=150, null=True, blank=True)),
        ))
        db.send_create_signal('holiday_manager', ['ClosurePeriod'])


    def backwards(self, orm):
        # Deleting model 'ClosurePeriod'
        db.delete_table('holiday_manager_closureperiod')
