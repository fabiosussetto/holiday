...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'HolidayApproval'
        db.create_table('holiday_manager_holidayapproval', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('approver', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['invites.User'])),
            ...
            ('changed_on', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
        ))
        db.send_create_signal('holiday_manager', ['HolidayApproval'])


    def backwards(self, orm):
        # Deleting model 'HolidayApproval'
        db.delete_table('holiday_manager_holidayapproval')
