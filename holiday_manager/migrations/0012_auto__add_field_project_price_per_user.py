...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Project.price_per_user'
        db.add_column('holiday_manager_project', 'price_per_user',
                      self.gf('django.db.models.fields.FloatField')(default=None),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Project.price_per_user'
        db.delete_column('holiday_manager_project', 'price_per_user')
