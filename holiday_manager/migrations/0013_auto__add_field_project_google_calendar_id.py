...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Project.google_calendar_id'
        db.add_column('holiday_manager_project', 'google_calendar_id',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Project.google_calendar_id'
        db.delete_column('holiday_manager_project', 'google_calendar_id')
