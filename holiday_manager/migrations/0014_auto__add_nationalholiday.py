...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'NationalHoliday'
        db.create_table('holiday_manager_nationalholiday', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('country_code', self.gf('django.db.models.fields.CharField')(max_length=10)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=150)),
            ('date', self.gf('django.db.models.fields.DateField')()),
        ))
        db.send_create_signal('holiday_manager', ['NationalHoliday'])


    def backwards(self, orm):
        # Deleting model 'NationalHoliday'
        db.delete_table('holiday_manager_nationalholiday')
