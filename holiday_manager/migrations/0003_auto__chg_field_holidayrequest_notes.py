...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'HolidayRequest.notes'
        db.alter_column('holiday_manager_holidayrequest', 'notes', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'HolidayRequest.notes'
        raise RuntimeError("Cannot reverse this migration. 'HolidayRequest.notes' and its values cannot be restored.")
