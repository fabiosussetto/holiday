...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Project.plan'
        db.add_column('holiday_manager_project', 'plan',
                      self.gf('django.db.models.fields.CharField')(default='free', max_length=20),
                      keep_default=False)

        # Adding field 'Project.plan_users'
        db.add_column('holiday_manager_project', 'plan_users',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=3),
                      keep_default=False)

        # Adding field 'Project.trial_start'
        db.add_column('holiday_manager_project', 'trial_start',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Project.plan'
        db.delete_column('holiday_manager_project', 'plan')

        # Deleting field 'Project.plan_users'
        db.delete_column('holiday_manager_project', 'plan_users')

        # Deleting field 'Project.trial_start'
        db.delete_column('holiday_manager_project', 'trial_start')
