...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'HolidayApproval.project'
        raise RuntimeError("Cannot reverse this migration. 'HolidayApproval.project' and its values cannot be restored.")
