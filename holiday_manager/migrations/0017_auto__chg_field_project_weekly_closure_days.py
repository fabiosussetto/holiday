...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Project.weekly_closure_days'
        db.alter_column('holiday_manager_project', 'weekly_closure_days', self.gf('holiday_manager.fields.ListField')(max_length=200, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Project.weekly_closure_days'
        raise RuntimeError("Cannot reverse this migration. 'Project.weekly_closure_days' and its values cannot be restored.")
